...
const en = {
  ...
  camera: "Camera",
  writeMessage: "A note for {couple}",
  ...
  guestbook: "Guestbook",
  guestbookEmpty: "The first note is yours — tap + then “A note for {couple}”.",
...
const fr: Dict = {
  ...
  camera: "Caméra",
  writeMessage: "Un mot pour {couple}",
  ...
  guestbookEmpty: "Le premier mot est à toi — touche + puis « Un mot pour {couple} ».",
