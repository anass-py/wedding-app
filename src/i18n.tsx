...
const en = {
  ...
  reconnectHint: "Your name and the code on your card.",
  reconnectName: "Name or handle",
  reconnectCode: "Code",
  reconnect: "Reconnect",
  reconnectFailed: "Name or code doesn’t match.",
  backToJoin: "New here? Join",
  recoveryTitle: "Your reconnect code",
  recoveryHint: "To find your card again on another phone.",
  copied: "Copied",
  joinWithName: "Name",
...
const fr: Dict = {
  ...
  reconnectHint: "Ton prénom et le code de ta carte.",
  reconnectName: "Prénom ou pseudo",
  reconnectCode: "Code",
  reconnect: "Me reconnecter",
  reconnectFailed: "Le prénom ou le code ne correspond pas.",
  backToJoin: "Nouveau ici ? M’inscrire",
  recoveryTitle: "Ton code de reconnexion",
  recoveryHint: "Pour retrouver ta carte sur un autre téléphone.",
  copied: "Copié",
  joinWithName: "Prénom",
