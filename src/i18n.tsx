...
const en = {
  ...
  camera: "Camera",
  writeMessage: "A note for ten years from now",
  trends: "Trends",
  trendsEyebrow: "To reproduce on the day",
  trendsSub: "Reels worth stealing. Like the ones we should do.",
  trendsEmpty: "Nothing yet. Tap + then “A trend to reproduce” and paste a link.",
  addTrend: "A trend to reproduce",
  trendUrlPlaceholder: "Paste an Instagram, TikTok or YouTube link",
  trendNotePlaceholder: "Why this one? (optional)",
  trendInvalidUrl: "That doesn’t look like a link.",
  trendSent: "Added!",
  trendCelebrate: "On the trends board, for everyone to vote.",
  confirmDeleteTrend: "Delete this trend?",
  comments: "Comments",
  noComments: "Be the first to say something.",
  commentPlaceholder: "Add a comment…",
  trendPending: "The video is on its way…",
  trendFailed: "This one wouldn’t come through — the link may be private.",
  composeTitle: "What they’ll reread in ten years.",
  ...
  guestbook: "Guestbook",
  guestbookEmpty: "The first note is yours — tap + then “A note for ten years from now”.",
...
const fr: Dict = {
  ...
  camera: "Caméra",
  writeMessage: "Un mot pour dans dix ans",
  trends: "Tendances",
  trendsEyebrow: "À refaire le jour J",
  trendsSub: "Des reels qui méritent d’être volés. Like ceux qu’on doit faire.",
  trendsEmpty: "Rien encore. Touche + puis « Une tendance à refaire » et colle un lien.",
  addTrend: "Une tendance à refaire",
  trendUrlPlaceholder: "Colle un lien Instagram, TikTok ou YouTube",
  trendNotePlaceholder: "Pourquoi celle-là ? (optionnel)",
  trendInvalidUrl: "Ça ne ressemble pas à un lien.",
  trendSent: "Ajoutée !",
  trendCelebrate: "Sur le tableau des tendances, à voter.",
  confirmDeleteTrend: "Supprimer cette tendance ?",
  comments: "Commentaires",
  noComments: "Sois le premier à dire quelque chose.",
  commentPlaceholder: "Ajoute un commentaire…",
  trendPending: "La vidéo arrive…",
  trendFailed: "Celle-là n’est pas passée — le lien est peut-être privé.",
  composeTitle: "Ce qu’ils reliront dans dix ans.",
  ...
  guestbookEmpty: "Le premier mot est à toi — touche + puis « Un mot pour dans dix ans ».",
