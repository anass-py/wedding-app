...
const en = {
  ...
  optional: "optional",
  join: "I’m here",
  alreadyJoined: "Already joined? Reconnect",
  reconnectTitle: "Welcome back",
  reconnectHint: "Type the name you joined with.",
  reconnectName: "Name or handle",
  reconnect: "Reconnect",
  reconnectFailed: "No card with that name.",
  nameTaken: "That name is already taken — reconnect instead, or pick another.",
  backToJoin: "New here? Join",
  joinWithName: "Name",
  ...
  camera: "Camera",
  writeMessage: "A word for the newlyweds",
  messagePlaceholder: "Something for them to keep…",
  send: "Send",
  sending: "Sending…",
  messageSent: "Sent!",
  messageCelebrate: "Straight into their guestbook.",
  guestbook: "Guestbook",
  guestbookEmpty: "The first word is yours — tap + then “A word for the newlyweds”.",
  messagesCount: "{n} words",
  messageOne: "1 word",
  groom: "The groom",
  bride: "The bride",
...
const fr: Dict = {
  ...
  optional: "optionnel",
  join: "Je suis là",
  alreadyJoined: "Déjà inscrit ? Me reconnecter",
  reconnectTitle: "Content de te revoir",
  reconnectHint: "Le prénom avec lequel tu t’es inscrit.",
  reconnectName: "Prénom ou pseudo",
  reconnect: "Me reconnecter",
  reconnectFailed: "Aucune carte à ce nom.",
  nameTaken: "Ce prénom est déjà pris — reconnecte-toi, ou choisis-en un autre.",
  backToJoin: "Nouveau ici ? M’inscrire",
  joinWithName: "Prénom",
  ...
  camera: "Caméra",
  writeMessage: "Un mot pour les mariés",
  messagePlaceholder: "Quelque chose qu’ils garderont…",
  send: "Envoyer",
  sending: "Envoi…",
  messageSent: "Envoyé !",
  messageCelebrate: "Direct dans leur livre d’or.",
  guestbook: "Livre d’or",
  guestbookEmpty: "Le premier mot est à toi — touche + puis « Un mot pour les mariés ».",
  messagesCount: "{n} mots",
  messageOne: "1 mot",
  groom: "Le marié",
  bride: "La mariée",
  confirmDeleteMessage: "Supprimer ce message ?",
  saveHint: "Appuie longuement sur l’image pour l’enregistrer.",
  gallery: "Galerie",
