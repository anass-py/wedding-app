...
const en = {
  ...
  optional: "optional",
  join: "Join the wall",
  joinWithName: "With my name",
  joinWithSocial: "With a network",
  handlePlaceholder: "your {network} username",
  socialNote: "We only keep the username — it becomes your name on the wall and links from your card.",
  joining: "Joining…",
  wall: "Wall",
  top: "Top 5",
...
const fr: Dict = {
  ...
  joinWithName: "Avec mon prénom",
  joinWithSocial: "Avec un réseau",
  handlePlaceholder: "ton pseudo {network}",
  socialNote: "On ne garde que le pseudo — il devient ton nom sur le mur et un lien sur ta carte.",
  joining: "Connexion…",
  wall: "Mur",
  top: "Top 5",
